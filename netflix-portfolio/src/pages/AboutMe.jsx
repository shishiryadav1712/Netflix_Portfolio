...
const paragraphs = [
  ...
  `💼 Currently, I work on mortgage and underwriting systems at Freddie Mac, where I’ve built microservices, improved processing efficiency, and implemented real-time event-driven pipelines using Kafka. Previously at Persistent Systems, I developed insurance and risk platforms, reducing manual processing effort and improving system performance at scale.I bring hands-on experience across distributed systems, cloud platforms (AWS, Azure), containerization (Docker, Kubernetes), and CI/CD pipelines—focusing on building resilient, production-grade applications that meet both performance and compliance requirements.`,
