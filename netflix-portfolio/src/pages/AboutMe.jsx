...
const paragraphs = [
  ...
  `💼 Currently, I work as a Java Full Stack Developer at Charles Schwab, where I build real-time trading and brokerage applications using Java, Spring Boot, Spring WebFlux, React, Angular, Kafka, Redis, and AWS. I develop high-performance microservices, implement event-driven architectures, and deploy cloud-native applications on Kubernetes using Docker, Terraform, and GitHub Actions. Previously, at HCL Technologies, I worked across banking, insurance, healthcare, telecom, and retail projects, developing scalable microservices, secure REST APIs, and responsive web applications using Java, Spring Boot, Angular, and React. Overall, I bring strong hands-on experience in distributed systems, cloud platforms (AWS), containerization (Docker, Kubernetes), CI/CD automation, and building resilient, scalable, production-grade enterprise applications with a focus on performance, reliability, and security.`,

  `🎓 With a Master’s in Computer Science from Purdue University, I’ve also worked on projects ranging from scalable backend systems to high-performance frontend applications, always aiming for clean architecture and measurable impact.`,
